...
/gurui
  ...
  } else if (text.hashCode() == 1692458775) {
    var imgUrl = "https://i.pinimg.com/originals/0d/52/33/0d52339908d5aeb3b8bb082c2ddbfd38.gif";
    slackSend(response_url, { response_type: "in_channel", attachments: [{ fallback: "hello", image_url: imgUrl }] });
  } else {
